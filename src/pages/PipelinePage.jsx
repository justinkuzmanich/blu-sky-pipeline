            ...
            return (
              <div key={si}
                ...
                <div style={{ padding:'11px 13px 9px', borderBottom:'1px solid #C8C1B4' }}>
                  ...
                  <div style={{ fontSize:16, fontFamily:"'DM Mono',monospace", color:'var(--text-1)', marginTop:4, fontWeight:500, visibility: stDeals.length > 0 ? 'visible' : 'hidden' }}>{fmt$(stageTotal(si))}</div>
                </div>
